...
% -- | --  | -- | RA | 16 | 4 | 3 | 77
\newcommand{\imgMNALGOMCLF}{23.2}
\newcommand{\imgMNALGOMclfWOP}{6.6}
\newcommand{\imgMNALGOFIXref}{85}
\newcommand{\imgMNALGOSACref}{2}
\newcommand{\imgMNALGOPSOref}{11}
\newcommand{\imgMNALGOSPref}{2}
\newcommand{\imgMNALGOFIXcod}{6}
\newcommand{\imgMNALGOSACcod}{13}
\newcommand{\imgMNALGOPSOcod}{6}
\newcommand{\imgMNALGOSPcod}{75}
% ### img
% Comparison | MCLF | MCLFw/oP | Method | Fix | Sacc | PSO | SP
% --- | --- | --- | --- | --- | --- | --- | ---
% MN v ALGO | 23.2 | 6.6 | MN | 85 | 2 | 11 | 2
% -- | --  | -- | ALGO | 6 | 13 | 6 | 75
\newcommand{\dotsMNALGOMCLF}{18.6}
\newcommand{\dotsMNALGOMclfWOP}{8.2}
\newcommand{\dotsMNALGOFIXref}{9}
\newcommand{\dotsMNALGOSACref}{5}
\newcommand{\dotsMNALGOPSOref}{8}
\newcommand{\dotsMNALGOSPref}{78}
\newcommand{\dotsMNALGOFIXcod}{77}
\newcommand{\dotsMNALGOSACcod}{6}
\newcommand{\dotsMNALGOPSOcod}{2}
\newcommand{\dotsMNALGOSPcod}{15}
% ### dots
% Comparison | MCLF | MCLFw/oP | Method | Fix | Sacc | PSO | SP
% --- | --- | --- | --- | --- | --- | --- | ---
% MN v ALGO | 18.6 | 8.2 | MN | 9 | 5 | 8 | 78
% -- | --  | -- | ALGO | 77 | 6 | 2 | 15
\newcommand{\videoMNALGOMCLF}{31.5}
\newcommand{\videoMNALGOMclfWOP}{7.9}
\newcommand{\videoMNALGOFIXref}{57}
\newcommand{\videoMNALGOSACref}{1}
\newcommand{\videoMNALGOPSOref}{6}
\newcommand{\videoMNALGOSPref}{36}
\newcommand{\videoMNALGOFIXcod}{36}
\newcommand{\videoMNALGOSACcod}{5}
\newcommand{\videoMNALGOPSOcod}{3}
\newcommand{\videoMNALGOSPcod}{55}
% ### video
% Comparison | MCLF | MCLFw/oP | Method | Fix | Sacc | PSO | SP
% --- | --- | --- | --- | --- | --- | --- | ---
% MN v ALGO | 31.5 | 7.9 | MN | 57 | 1 | 6 | 36
% -- | --  | -- | ALGO | 36 | 5 | 3 | 55
\newcommand{\imgRAALGOMCLF}{22.8}
\newcommand{\imgRAALGOMclfWOP}{6.4}
\newcommand{\imgRAALGOFIXref}{77}
\newcommand{\imgRAALGOSACref}{3}
\newcommand{\imgRAALGOPSOref}{11}
\newcommand{\imgRAALGOSPref}{9}
\newcommand{\imgRAALGOFIXcod}{13}
\newcommand{\imgRAALGOSACcod}{13}
\newcommand{\imgRAALGOPSOcod}{6}
\newcommand{\imgRAALGOSPcod}{68}
% ### img
% Comparison | MCLF | MCLFw/oP | Method | Fix | Sacc | PSO | SP
% --- | --- | --- | --- | --- | --- | --- | ---
% RA v ALGO | 22.8 | 6.4 | RA | 77 | 3 | 11 | 9
% -- | --  | -- | ALGO | 13 | 13 | 6 | 68
\newcommand{\dotsRAALGOMCLF}{22.8}
\newcommand{\dotsRAALGOMclfWOP}{10.8}
\newcommand{\dotsRAALGOFIXref}{28}
\newcommand{\dotsRAALGOSACref}{4}
\newcommand{\dotsRAALGOPSOref}{6}
\newcommand{\dotsRAALGOSPref}{61}
\newcommand{\dotsRAALGOFIXcod}{59}
\newcommand{\dotsRAALGOSACcod}{7}
\newcommand{\dotsRAALGOPSOcod}{2}
\newcommand{\dotsRAALGOSPcod}{31}
% ### dots
% Comparison | MCLF | MCLFw/oP | Method | Fix | Sacc | PSO | SP
% --- | --- | --- | --- | --- | --- | --- | ---
% RA v ALGO | 22.8 | 10.8 | RA | 28 | 4 | 6 | 61
% -- | --  | -- | ALGO | 59 | 7 | 2 | 31
\newcommand{\videoRAALGOMCLF}{28.5}
\newcommand{\videoRAALGOMclfWOP}{9.1}
\newcommand{\videoRAALGOFIXref}{38}
\newcommand{\videoRAALGOSACref}{3}
\newcommand{\videoRAALGOPSOref}{5}
\newcommand{\videoRAALGOSPref}{55}
\newcommand{\videoRAALGOFIXcod}{53}
\newcommand{\videoRAALGOSACcod}{6}
\newcommand{\videoRAALGOPSOcod}{5}
\newcommand{\videoRAALGOSPcod}{35}
% ### video
% Comparison | MCLF | MCLFw/oP | Method | Fix | Sacc | PSO | SP
% --- | --- | --- | --- | --- | --- | --- | ---
% RA v ALGO | 28.5 | 9.1 | RA | 38 | 3 | 5 | 55
% -- | --  | -- | ALGO | 53 | 6 | 5 | 35
