...
set of algorithms. \todo[inline]{\textit{Table (or a graphic?) showing duration
mean, SD, count and RMSD (tables 3-4, Anderson) for images, dots and videos }}
...
videos, but RMSD = 2.1 for dots. TODO: now how do we do?  \todo[inline]{compute
RMSD for algo comparison}\todo[inline]{how do we compare against the ``best"
  LNS algorithm in Andersson2017?}
