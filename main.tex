...
\begin{document}
    ...
    \begin{figure*}[h!]
        ...
        \includegraphics[trim=0 12mm 0 0,clip,width=1\textwidth]{img/remodnav_lab.pdf} \\
        ...
        How ``zoomed in" (Anderson depicted about 10 samples in their fig. 1).}Exemplary classification
