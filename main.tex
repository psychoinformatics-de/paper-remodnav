...
\begin{figure*}
  ...
  exceeding a configurable pursuit velocity threshold are classified as pursuits,
  and segments that do not qualify as pursuits are classified as fixations.
  }
  \label{fig:alg}
\end{figure*}
