...
\begin{figure*}[tbp]
  ...
  \caption{Exemplary classification performance of \remodnav\ in a high quality lab sample (top) and low
  quality MRI sample (bottom), each for the same 10 seconds of movie stimulus.
