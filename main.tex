...
we define the different supported eye-movements
...
emphasized by \cite{Andersson2017}.
...
\param{min\_blink\_duration}; \fig{alg}A, 2). This is due to the fact that
blinks produce artifacts in the eye-tracking signal when the eyelid closes
...
\begin{figure*}
  ...
  \todo[inline]{this could become a table}}
  \label{fig:alg}
\end{figure*}
