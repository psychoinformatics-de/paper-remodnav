...
\onecolumn
\title{REMoDNaV: Robust Eye-Movement Classification for Dynamic Videos } %\\ (remodnav)
...
If this type of eye movement is not properly detected and labeled,
...
videos), a new tool that aims to meet our objectives and classifies the
...
filter\_length}) is used to emphasize large amplitude saccades.  This type of
...
\fig{velest2} exemplifies event classification within such an intersaccadic interval.
...
\begin{figure*}[tbp]
  ...
  purple). The bottom panel shows \unit[2]{s} of unfiltered gaze coordinates
...
\citep[Technical Validation]{Hanke2016} and a generally higher amount of data loss.
...
that performs robustly on prolonged recordings
...
pupil-CR eye tracking may bias data towards premature PSO onset times and
