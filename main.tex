...
(\param{dilate\_nan}, \param{min\_blink\_duration}; \fig{alg}A, 2). This is based
on the fact that blinks can produce artifacts in the eye-tracking signal when the
