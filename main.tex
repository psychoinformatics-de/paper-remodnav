...
\subsection*{Detection of saccades and post-saccadic oscilations}

Detection of these event types as identical to the NH algorithm, only the data
...
tab-separated-value (TSV) text files. The contain a report on one detected
...
if applicable, default value, are listed in table \ref{tab:parameters}.  While
