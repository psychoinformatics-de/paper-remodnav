...
dot category (JI of .79 and .75, respectively), and still good in the video
category (JI of .56 and .63, respectively).
\todo[inline]{if we keep these values in here, we might want to make Latex
commands for them as well? }
