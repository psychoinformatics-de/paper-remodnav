...
Just as the original algorithm, its frame of reference is world centered, that
is, the gaze coordinates have a reference to a stimulation set-up with a fixed
position in the world such x and y coordinates in pixel of a computer screen.
Furthermore, it adds
support for pursuit event detection. Apart from this, it is built and distributed
as free, open source software, and can be easily obtained and executed with free
tools. We evaluated \remodnav\ on three different
