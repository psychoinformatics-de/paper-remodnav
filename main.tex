...
study on eve movement detection algorithms. Moreover, the dataset employed
...
misclassification rates for all pairwise comparisons, and all stimulus types.
...
labeling similarity that reaches the human inter-rater aggreement, it still
performs well. In particular, the relative magnitude of agreement with each
individual human coder for fixations, saccades, and PSOs, resembles that of the
agreement of the human coders with each other. Classification of smooth
...
to the ten algorithms studies in \citet{Andersson2017}, we followed their
...
between high and lower quality sample, we computed the event distribution
