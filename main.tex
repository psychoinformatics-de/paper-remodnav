...
\fig{alg}, P3). A relatively large median filter (\param{median\_
...
\fig{vels}) highlights the higher amount of extreme velocities in the MRI sample.
...
\begin{figure}
  \label{vels}
  \caption{Velocities of events in the MRI and laboratory setting across all
  runs and participants. The MRI sample shows a larger amount of high velocity
  samples.}
